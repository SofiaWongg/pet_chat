...
class Conversation(SQLModel, table=True):
    ...
    def add_message(self, message: str, sender_type: Literal["user", "pet"], session: Session):
...
class Pet(SQLModel, table=True):
    ...
    def chat(self, user_id: int, session: Session, message: str):
        ...
        conversation_history.add_message(message=message, sender_type="user", session=session)
